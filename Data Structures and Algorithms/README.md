...
[Code Review](https://youtu.be/4Do-wYV8RH8)
...
The project here shows the different data structures and my ability to program them along with the implementation of the binary search tree in the project. The graphic is to explain and demonstrate the different data structures in simple terms that anyone can understand. 
